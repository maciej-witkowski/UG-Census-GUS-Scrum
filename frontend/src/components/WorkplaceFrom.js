...
const WorkplaceForm = ({previousPage, poll, dispatch, nextPage}) => {
        ...
        <div className={"box m-6 field is-centered"}>
            <div className={"field is-centered"}>
                ...
                <div className={"column is-centered mx-5 is-5 mt-5 mb-4"}>
                    ...
                    <input disabled={poll.filled ? "disabled" : ""} type="button" onClick={next} className={"button is-success is-medium"} value="Podsumowanie"/>
                </div>
            </div>
        </div>)
}
